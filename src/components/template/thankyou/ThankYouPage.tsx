          ...
          <Card className="mb-8 border-primary/20">
            <CardContent className="pt-6">
              <p className="mb-4 leading-relaxed text-muted-foreground">
                ...
                Therapy! We appreciate your trust in us to support your child
                and family&apos;s well-being.
              </p>
              <p className="mb-4 leading-relaxed text-muted-foreground">
                As the consultation date approaches, we want to ensure
                everything goes smoothly for you. You can expect a friendly
                reminder 24 hours in advance of your appointment, just to help
                you keep it on your calendar.
              </p>
              <p className="mb-4 leading-relaxed text-muted-foreground">
                If you have any questions or need to get in touch with us before
                the consultation, please don&apos;t hesitate to reach out. You
                ...
                assist you in any way we can. You can also explore our FAQ at
                any point.
              </p>
            </CardContent>
          </Card>
